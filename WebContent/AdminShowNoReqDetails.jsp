...
<% String corp = request.getParameter("corp");
       ...
       String ShowAllCorps = request.getParameter("allCorps");
       if(ShowAllCorps.equals("Show All Corps"))
       {
    	   corp = ShowAllCorps;
       }
       String hrefUrl ="/Amdocs/ShowCorp.jsp?corp="+corp+"&version="+version+"&env="+env;
       System.out.println("AdminShowNoReqDetails.jsp on click of BACK hrefUrl : "+hrefUrl);
       %>
</script>
</br></br>
<div align="center">
